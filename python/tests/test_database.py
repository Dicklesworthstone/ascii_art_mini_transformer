...
"""
    ...
    def test_full_text_search(self, db):
        ...
        db.insert(raw_text=art1, source='test', title='Cute Cat', description='A fluffy cat')
        db.insert(raw_text=art2, source='test', title='Happy Dog', description='A happy dog')
    ...
    def test_search_by_category(self, db):
        ...
        db.insert(raw_text="cat\nart\nhere\ntest", source='test', category='animal', subcategory='cat')
        db.insert(raw_text="tree\nart\nhere\ntest", source='test', category='nature', subcategory='tree')
